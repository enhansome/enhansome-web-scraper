...
* [crawler4j](https://github.com/yasserg/crawler4j) ⭐ 4,620 | 🐛 188 | 🌐 Java | 📅 2021-11-04 - open source web crawler for Java which provides a simple interface for crawling the Web. Using it, you can setup a multi-threaded web crawler in few minutes.
...
* [scrapy](https://github.com/scrapy/scrapy) ⭐ 64,154 | 🐛 441 | 🌐 Python | 📅 2026-09-01 - Scrapy, a fast high-level web crawling & scraping framework for Python.
* [trafilatura](https://github.com/adbar/trafilatura) ⭐ 6,748 | 🐛 61 | 🌐 Python | 📅 2026-08-28 - Library and command-line tool to extract metadata, main text, and comments.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,534 | 🐛 263 | 🌐 TypeScript | 📅 2026-08-31 - Headless Chrome Node API <https://pptr.dev>.
* [Phantomjs](https://github.com/ariya/phantomjs) ⚠️ Archived - Scriptable Headless WebKit.
* [jsdom](https://github.com/jsdom/jsdom) ⭐ 21,664 | 🐛 405 | 🌐 JavaScript | 📅 2026-09-01 - A JavaScript implementation of the WHATWG DOM and HTML standards, for use with node.js
...
* [node-crawler](https://github.com/bda-research/node-crawler) ⭐ 6,796 | 🐛 29 | 🌐 TypeScript | 📅 2026-06-18 - Web Crawler/Spider for NodeJS + server-side jQuery.
