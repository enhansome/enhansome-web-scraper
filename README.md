...
* [scrapy](https://github.com/scrapy/scrapy) ⭐ 64,368 | 🐛 384 | 🌐 Python | 📅 2026-09-16 - Scrapy, a fast high-level web crawling & scraping framework for Python.
* [trafilatura](https://github.com/adbar/trafilatura) ⭐ 6,825 | 🐛 61 | 🌐 Python | 📅 2026-09-11 - Library and command-line tool to extract metadata, main text, and comments.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,584 | 🐛 260 | 🌐 TypeScript | 📅 2026-09-16 - Headless Chrome Node API <https://pptr.dev>.
* [Phantomjs](https://github.com/ariya/phantomjs) ⚠️ Archived - Scriptable Headless WebKit.
* [jsdom](https://github.com/jsdom/jsdom) ⭐ 21,683 | 🐛 404 | 🌐 JavaScript | 📅 2026-09-16 - A JavaScript implementation of the WHATWG DOM and HTML standards, for use with node.js
...
* [node-crawler](https://github.com/bda-research/node-crawler) ⭐ 6,791 | 🐛 29 | 🌐 TypeScript | 📅 2026-06-18 - Web Crawler/Spider for NodeJS + server-side jQuery.
