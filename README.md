...
* [scrapy](https://github.com/scrapy/scrapy) ⭐ 64,257 | 🐛 399 | 🌐 Python | 📅 2026-09-09 - Scrapy, a fast high-level web crawling & scraping framework for Python.
* [trafilatura](https://github.com/adbar/trafilatura) ⭐ 6,787 | 🐛 64 | 🌐 Python | 📅 2026-08-28 - Library and command-line tool to extract metadata, main text, and comments.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,558 | 🐛 258 | 🌐 TypeScript | 📅 2026-09-09 - Headless Chrome Node API <https://pptr.dev>.
* [Phantomjs](https://github.com/ariya/phantomjs) ⚠️ Archived - Scriptable Headless WebKit.
* [jsdom](https://github.com/jsdom/jsdom) ⭐ 21,673 | 🐛 407 | 🌐 JavaScript | 📅 2026-09-08 - A JavaScript implementation of the WHATWG DOM and HTML standards, for use with node.js
...
* [reqwest](https://github.com/seanmonstar/reqwest) ⭐ 11,813 | 🐛 470 | 🌐 Rust | 📅 2026-09-08 - An ergonomic, batteries-included HTTP Client for Rust.
* [scraper](https://github.com/causal-agent/scraper) ⭐ 2,418 | 🐛 11 | 🌐 Rust | 📅 2026-09-07 - HTML parsing and querying with CSS selectors.
