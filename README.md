...
* [scrapy](https://github.com/scrapy/scrapy) ⭐ 64,083 | 🐛 448 | 🌐 Python | 📅 2026-08-28 - Scrapy, a fast high-level web crawling & scraping framework for Python.
* [trafilatura](https://github.com/adbar/trafilatura) ⭐ 6,723 | 🐛 59 | 🌐 Python | 📅 2026-08-28 - Library and command-line tool to extract metadata, main text, and comments.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,515 | 🐛 263 | 🌐 TypeScript | 📅 2026-08-28 - Headless Chrome Node API <https://pptr.dev>.
...
* [reqwest](https://github.com/seanmonstar/reqwest) ⭐ 11,803 | 🐛 469 | 🌐 Rust | 📅 2026-08-10 - An ergonomic, batteries-included HTTP Client for Rust.
