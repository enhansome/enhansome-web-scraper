...
* [scrapy](https://github.com/scrapy/scrapy) ⭐ 64,490 | 🐛 341 | 🌐 Python | 📅 2026-09-25 - Scrapy, a fast high-level web crawling & scraping framework for Python.
* [trafilatura](https://github.com/adbar/trafilatura) ⭐ 6,868 | 🐛 56 | 🌐 Python | 📅 2026-09-25 - Library and command-line tool to extract metadata, main text, and comments.
...
* [DiDOM](https://github.com/Imangazaliev/DiDOM) ⭐ 2,196 | 🐛 27 | 🌐 PHP | 📅 2026-01-28 - Simple and fast HTML parser.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,623 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-25 - Headless Chrome Node API <https://pptr.dev>.
* [Phantomjs](https://github.com/ariya/phantomjs) ⚠️ Archived - Scriptable Headless WebKit.
* [jsdom](https://github.com/jsdom/jsdom) ⭐ 21,691 | 🐛 304 | 🌐 JavaScript | 📅 2026-09-22 - A JavaScript implementation of the WHATWG DOM and HTML standards, for use with node.js
* [nightmare](https://github.com/segmentio/nightmare) ⭐ 19,773 | 🐛 201 | 🌐 JavaScript | 📅 2024-04-20 - Nightmare is a high level wrapper for PhantomJS that lets you automate browser tasks
...
* [xray](https://github.com/matthewmueller/x-ray) ⭐ 5,907 | 🐛 74 | 🌐 JavaScript | 📅 2026-08-31 - The next web scraper. See through the `<html>` noise.
...
* [reqwest](https://github.com/seanmonstar/reqwest) ⭐ 11,843 | 🐛 471 | 🌐 Rust | 📅 2026-09-24 - An ergonomic, batteries-included HTTP Client for Rust.
